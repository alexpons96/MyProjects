...
public class ControlDBInfo {
    ...
    public boolean buscarUsuari(Usuari usuari) {
        ...
        if (usuari.isNou_usuari()) {    // Això vol dir que és un REGISTRE:
            // chivato
            System.out.println("Ha entrado en el if de isNouUsuari (ha fet registre)");
            ...
            // chivato
            System.out.println("Ha entrado en el else de isNouUsuari (!isNouUsuari, ha fet login)");
    ...
    public String actualitzaControls(String[] smsClient, Usuari usuari) {
        ...
        // moar chivato
        for (int i = 0; i<4; i++) {
            System.out.println(smsClient[i]+"; ");
        }
