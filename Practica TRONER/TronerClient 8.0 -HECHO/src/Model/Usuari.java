...
/**
 * Classe model on hi ha tota la informació de l'usuari
...
public class Usuari implements Serializable {
    ...
    /**
     * Constructor complet de l'usuari
     * @param nickname  nick del usuari
     * @param password  contrassenya de l'usuari
     * @param correu    correu de l'usuari
     * @param registre  data de registre de l'usuari
     * @param ultim_acces   data d'ultim acces de l'usuari
     */
    public Usuari(String nickname, String password, String correu, Date registre, Date ultim_acces) {
