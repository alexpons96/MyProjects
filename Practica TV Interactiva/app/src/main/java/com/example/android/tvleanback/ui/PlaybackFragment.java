...
public class PlaybackFragment extends VideoSupportFragment {
    ...
    private static Video videoSearch;
    private Playlist mPlaylist;
    private VideoLoaderCallbacks mVideoLoaderCallbacks;
    private CursorObjectAdapter mVideoCursorAdapter;

    public void voidVideoSearch(Video video){
        videoSearch = video;
        System.out.println(videoSearch+"JEJEEJEJE");
        play(videoSearch);
    }
    public void read_firebase(){
        ...
        myRef.child("message").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String videoUrl = dataSnapshot.child("videoUrl").getValue().toString();
                String bgImageUrl = dataSnapshot.child("bgImageUrl").getValue().toString();
                String cardImageUrl = dataSnapshot.child("cardImageUrl").getValue().toString();
                String studio = dataSnapshot.child("studio").getValue().toString();

                Video mVideoDB = new Video(id,category,title,desc,videoUrl,bgImageUrl,cardImageUrl,studio);
                System.out.println(mVideoDB + "<---------- Message in firebase");
                mVideo = mVideoDB;
                System.out.println(mVideo + "<---------- MIRO SI HA CAMBIADO LOS DATOS");
                play(mVideoDB);
            }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println(VideoDetailsActivity.VIDEO + "<-------------------------");
    ...
    private void prepareMediaForPlaying(Uri mediaSourceUri) {
        ...
        String uri = mediaSourceUri.toString();
